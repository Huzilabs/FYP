...
payload = {
    ...
    'username': 'e2e_test_' + base64.b16encode(b'e2e').decode()[:8],
    'consent_terms': True,
    'image': data_url,
}
...
print('\nAttempting face login (may fail if pgvector missing)')
resp3 = requests.post(SERVER + '/api/login_face', json={'face_image': data_url, 'threshold': 0.6, 'limit': 1}, timeout=60)
